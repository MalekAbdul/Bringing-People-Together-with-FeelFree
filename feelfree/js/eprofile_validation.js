function eprofile(){
    if((eprofileName() && eprofilePhone() && eprofileEmail() && eprofilePass()) == 1){
        return true;
    } else{
        return false;
    }
...
function eprofilePass(){
    let password = document.getElementById('password');

    if(password.value.length == 0){
        return true;
    } else if(password.value.length > 0 && password.value.length < 8){
        document.getElementsByClassName('line-error')[3].innerHTML = 'Please, provide minimum 8 characters long.';
        ...
        document.getElementsByClassName('line-error')[3].innerHTML = 'Please, provide maximum 20 characters long.';
        document.getElementsByClassName('line-error')[3].style.cssText = 'visibility: visible; color: red;';
        document.getElementsByClassName('cfa')[7].style.cssText = 'visibility: visible; color: red;';
        document.getElementsByClassName('cfa')[6].style.cssText = 'visibility: hidden;';
        password.style.cssText = 'border-color: red;';
