...
?>
        ...
        <html lang="en">
            ...
            <body>
                ...
                <?php
                    if(isset($_SESSION['post_accept_success'])){
                        echo '<script type="text/javascript">Swal.fire({
                                    icon: "success",
                                    title: "Post accept successful!",
                                    showConfirmButton: false,
                                    timer: 1500
                                })
                            </script>';

                        unset($_SESSION['post_accept_success']);
                    ...
                    } elseif(isset($_SESSION['post_accept_fail'])){
                        echo '<script type="text/javascript">Swal.fire({
                                        icon: "error",
                                        title: "Oops...",
                        ...
                        ?>
                                    ...
                                    <div class="post-box">
                                        ...
                                        <div class="post-footer">
                                            <div class="left pfm"><a href="view-pending-post?ui=<?php echo base64_encode(($fetch['uid'] * 137) + 387); ?>&pid=<?php echo $fetch['pid']; ?>">View</a></div>
                                            <div class="right pfm">
                                                ...
                                                <div class="qview-menu">
                                                    <form class="acs-form" action="../cnnction/all_query.php" method="post">
                                                        <input name="accept_mp" type="text" value="accept_mp" hidden>
                                                        <input name="pid" type="text" value="<?php echo $fetch['pid']; ?>" hidden>
                                                        <input name="link" type="text" value="<?php echo $fullUrl; ?>" hidden>
                                                    </form>
                                                    <a href="#" onclick="document.getElementsByClassName('acs-form')[0].submit();"><i class="fa fa-check"></i></a>

                                                    <form class="acs-form" action="../cnnction/all_query.php" method="post">
                                                        <input name="decline_mp" type="text" value="decline_mp" hidden>
                                                        <input name="pid" type="text" value="<?php echo $fetch['pid']; ?>" hidden>
                                                        <input name="link" type="text" value="<?php echo $fullUrl; ?>" hidden>
                                                    </form>
                                                    ...
                                                    <form class="acs-form" action="../cnnction/all_query.php" method="post">
                                                        <input name="delete_mp" type="text" value="delete_mp" hidden>
                                                        <input name="pid" type="text" value="<?php echo $fetch['pid']; ?>" hidden>
                                                        <input name="link" type="text" value="<?php echo $fullUrl; ?>" hidden>
                                                    </form>
                                                ...
                                                <a href="javascript:void(0);" class="qview">QV</a>
                                            </div>
                                        </div>
